...
> [fork plan](https://github.com/Hackthecatboy/Kapowarr/blob/feature/sonarr-integrations/FORK_PLAN.md) and [Synology test setup](https://github.com/Hackthecatboy/Kapowarr/blob/feature/sonarr-integrations/docs/synology-ghcr.md).
